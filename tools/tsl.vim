...
syn keyword tslStatement	endtemplate fork function goal import init prefix know out 
syn keyword tslStatement	pause post procedure process return stop break switch task template transducer wait
